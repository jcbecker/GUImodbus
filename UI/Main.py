...
from ..Async.testingMonitor import testingMonitor
...
class Main:
    ...
    def __init__( self, root ):
        ...
        self.tempMonitor = testingMonitor()
    ...
    def line2(self):
		...
		self.wmBtn = Button( root, text = "Água", fg="blue", bg="white", activebackground="white",font=self.btnFont)
		...
		self.imBtn = Button( root, text = "Iluminação", fg="green", bg="white", activebackground="white",font=self.btnFont)
		...
		self.tmBtn.place(x = self.screenWidth*0.60 + self.distBetweenBtnSecLine*4,
					     ...
					     width = self.screenWidth*0.20,
					     height = self.screenHeight*0.10)
		self.tmBtn.bind("<Button-1>", self.tempMonitor.evento)
    ...
    def line4(self):
		...
		self.waBtn = Button( root, text = "Água", fg="blue", bg="white", activebackground="white",font=self.btnFont)
		...
		self.iaBtn = Button( root, text = "Iluminação", fg="green", bg="white", activebackground="white",font=self.btnFont)
